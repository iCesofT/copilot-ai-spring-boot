...
Skills are reusable prompts that teach GitHub Copilot specific patterns for Java development.
...
2. Create `SKILL.md` with instructions for GitHub Copilot
...
Skills are automatically loaded by GitHub Copilot based on context. You can also invoke them directly:

```bash
# Automatic - GitHub Copilot detects when to use skills
